...
public class Oauth2ClientConfiguration {
  @Bean
  ReactiveRedisOperations<Object, Object> reactiveRedisTemplate(
    ...
    RedisSerializationContext.RedisSerializationContextBuilder<Object, Object>
        serializationRedisBuilder =
            RedisSerializationContext.newSerializationContext(keySerializer).value(valueSerializer);

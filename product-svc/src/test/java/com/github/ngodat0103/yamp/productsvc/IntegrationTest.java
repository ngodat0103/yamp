...
public class IntegrationTest {
    ...
    void testCreateCategory() {
        var responseEntity =    testRestTemplate.postForEntity("/categories", categoryDtoRequest, CategoryDtoResponse.class);
    ...
    public void givenAlreadyHaveCategory_whenPostCategory_thenReturnException(){
        ...
        Assertions.assertEquals("https://problems-registry.smartbear.com/already-exists", problemDetail.getType().toString());
        Assertions.assertNotNull(problemDetail.getInstance());
        Assertions.assertEquals("/categories", problemDetail.getInstance().toString());
        Assertions.assertEquals("Category with name: \"Test Category\" already exists", problemDetail.getDetail());
    ...
    public void givenNothing_whenGetCategories_thenReturnCategories(){
        ...
        Assertions.assertEquals(slugify.slugify(categoryDtoRequest.getName()), categoryDtoResponse.getSlugName());
        ...
        Assertions.assertAll(
                () -> Assertions.assertEquals("/api/v1/product/categories/" + categoryDtoResponse.getSlugName(), slugNameLink.getHref()),

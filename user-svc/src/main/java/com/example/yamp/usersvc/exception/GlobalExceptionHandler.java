...
public class GlobalExceptionHandler  {
    ...
    public ProblemDetail handleWebClientRequestException(WebClientResponseException e, HttpServletRequest request, HttpServletResponse response) {
    ...
    public ProblemDetail handleMethodArgumentNotValidException(Exception e, HttpServletRequest request) {
        ProblemDetail  problemDetails = ProblemDetail.forStatus(HttpStatus.BAD_REQUEST);
        problemDetails.setType(URI.create("https://problems-registry.smartbear.com/invalid-body-property-value/"));
    ...
    @ResponseStatus(HttpStatus.BAD_REQUEST)
    public ProblemDetail handleHttpMediaTypeNotSupportedException(HttpMediaTypeNotSupportedException e, HttpServletRequest request) {
        ProblemDetail problemDetails = ProblemDetail.forStatus(HttpStatus.BAD_REQUEST);
